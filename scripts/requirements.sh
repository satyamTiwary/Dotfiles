...
function cli(){
  ...
  sudo apt-get -y install cmake ccache cppcheck texlive-latex-base texlive-latex-extra asciidoctor pandoc graphviz ttf-mscorefonts-installer gcc-avr clang-format
